# Lectures — Review Library

Knowledge-only notes generated at the end of each session. Re-read any topic here without starting a session.

Organized to mirror `modules/` — one file per topic. Topics taught across multiple sessions extend the same file.

## Index

| Module | Topic | Lecture | Last updated |
|--------|-------|---------|--------------|
| 01 — Web Foundations | How the Web Works | [1.1-how-the-web-works.md](01-web-foundations/1.1-how-the-web-works.md) | 2026-06-16 |
| 01 — Web Foundations | HTTP Fundamentals | [1.2-http-fundamentals.md](01-web-foundations/1.2-http-fundamentals.md) | 2026-06-16 |
...
| 02 — HTML & CSS | Accessibility Basics | [2.5-accessibility-basics.md](02-html-css/2.5-accessibility-basics.md) | 2026-06-21 |
...
| 07 — Frontend Testing & Quality | Web Performance & Core Web Vitals | [7.6-web-performance-core-vitals.md](07-frontend-testing-quality/7.6-web-performance-core-vitals.md) | 2026-09-17 |
